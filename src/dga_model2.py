...
def get_feature_2gram(modelname):
    alexa=load_alexa()
    dga=load_dga()
    x=alexa+dga
    max_features=10000
...
def get_feature_234gram(modelname):
    alexa=load_alexa()
    dga=load_dga()
    x=alexa+dga
    max_features=10000
...
if __name__ == "__main__":
    ...
    x, y = get_feature()
    model2 = do_nb(x, y)
    joblib.dump(model2, 'textfeature&nb2.model')
    ...
    print "234-gram & mlp"
    x, y = get_feature_234gram('234-gram&mlp')
    model1 = do_mlp(x, y)
